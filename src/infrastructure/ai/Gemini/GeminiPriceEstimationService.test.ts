...
import { GeminiPriceEstimationService } from './GeminiPriceEstimationService'

describe('GeminiPriceEstimationService', () => {
  it('should perform pre-estimation with filtering and search terms generation', async () => {
    if (!process.env.GOOGLE_GEMINI_API_KEY) {
      console.log('\n⚠️  GOOGLE_GEMINI_API_KEY not set, skipping test')
      return
    }

    const service = new GeminiPriceEstimationService(process.env.GOOGLE_GEMINI_API_KEY)
