...
import { PamonoScraper } from './PamonoScraper'

describe('PamonoScraper', () => {
  it('should scrape pamono.fr for a search query', async () => {
    const scraper = new PamonoScraper()
    
    const query = 'table basse maison jansen'
    
    console.log('\n🔍 Recherche:', query)
    console.log('📋 Site: Pamono')
    console.log('\n⏳ Scraping en cours...\n')
