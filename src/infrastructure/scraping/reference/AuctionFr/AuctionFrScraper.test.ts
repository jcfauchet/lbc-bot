...
import { AuctionFrScraper } from './AuctionFrScraper'

describe('AuctionFrScraper', () => {
  it('should scrape auction.fr for a search query', async () => {
    const scraper = new AuctionFrScraper()
    
    const query = 'table basse verre maison jansen'
    
    console.log('\n🔍 Recherche:', query)
    console.log('📋 Site: AuctionFR')
    console.log('\n⏳ Scraping en cours...\n')
