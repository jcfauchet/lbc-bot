...
import { SelencyScraper } from './SelencyScraper'

describe('SelencyScraper', () => {
  it('should scrape selency.com for a search query', async () => {
    const scraper = new SelencyScraper()
    
    const query = 'maison jansen'
    
    console.log('\n🔍 Recherche:', query)
    console.log('📋 Site: selency')
    console.log('\n⏳ Scraping en cours...\n')
